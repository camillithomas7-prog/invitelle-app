...
(function () {
  ...
  function tabEnvelope() {
    ...
    const customHTML = custom ? `
      ...
      <div class="sec"><h3>2. Stile della busta</h3><div class="seg">
        <button type="button" data-set="envelope.style" data-v="ceralacca" class="${e.style === 'ceralacca' ? 'on' : ''}">Ceralacca classica</button>
        <button type="button" data-set="envelope.style" data-v="floreale" class="${e.style === 'floreale' ? 'on' : ''}">Rilievo floreale</button></div></div>

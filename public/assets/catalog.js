...
window.INV = {
  ...
  flowers: [
    ...
    { id: 'classico', name: 'Classico', img: '/media/flowers/classico.webp' },
    { id: 'gigli-rose', name: 'Gigli e rose', img: '/media/flowers/gigli-rose.webp' },
    { id: 'eucalipto', name: 'Eucalipto', img: '/media/flowers/eucalipto.webp' },
    { id: 'peonie', name: 'Peonie', img: '/media/flowers/peonie.webp' },
    { id: 'ranuncoli', name: 'Ranuncoli pesca', img: '/media/flowers/ranuncoli.webp' },
    { id: 'glicine', name: 'Glicine', img: '/media/flowers/glicine.webp' },
    { id: 'limoni', name: 'Limoni di Amalfi', img: '/media/flowers/limoni.webp' },
    { id: 'ulivo', name: 'Rami d\'ulivo', img: '/media/flowers/ulivo.webp' },
    { id: 'boho', name: 'Boho pampas', img: '/media/flowers/boho.webp' },
    { id: 'campo', name: 'Fiori di campo', img: '/media/flowers/campo.webp' },
    { id: 'inverno', name: 'Invernale', img: '/media/flowers/inverno.webp' },
